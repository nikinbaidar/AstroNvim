...
s("mindrayserviceorder", {
  i(2, "Instrument type"),
  m(2, function(args)
    return (args[1][1] == "A" and "nesthesia machine"
      or args[1][1] == "E" and "CG machine"
      or args[1][1] == "P" and "atient monitor"
      or args[1][1] == "S" and "yringe pump"
      or args[1][1] == "I" and "nfusion pump"
      or args[1][1] == "V" and "entilator"
    )
  end),
  t({"", ""}),
  d(3, function(args)
    local key = args[1][1]
      ...
      local choices = models[key] or { t("Model") }
	...
	s("mat", {
		...
		t(": "),
		m(1, function(args)
		  return (args[1][1] == "border-" and "hi" or args[1][1] == "block-" and "you" or args[1][1])
		end),
	}),
